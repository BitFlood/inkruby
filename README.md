...
InkRuby is an Obsidian plugin designed to render the styling of ancient Chinese poetry and Literary Chinese. By using designated code blocks, it adds Pinyin annotations and interlinear notes to text.
